...
public abstract class BaseListTupleImpl<E extends Writable> extends
		BaseTupleImpl<E> implements BaseListTuple<E> {
	private static final long serialVersionUID = 1L;

	public BaseListTupleImpl() {
		super();
	}

	public BaseListTupleImpl(E... elements) {
		super(elements);
	}
